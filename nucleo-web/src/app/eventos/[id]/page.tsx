                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-slate-900">Fecha</p>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-3">
                      <Button variant="outline" className="w-full justify-start" asChild>
                        <Link href={`https://wa.me/?text=${encodeURIComponent(`¡Mira este evento: ${event.title} - ${process.env.NEXT_PUBLIC_SITE_URL || 'https://nucleo.com'}/eventos/${event.id}`)}`} target="_blank">
                          Compartir por WhatsApp
                        </Link>
                      </Button>
                      <Button variant="outline" className="w-full justify-start" asChild>
                        <Link href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`${process.env.NEXT_PUBLIC_SITE_URL || 'https://nucleo.com'}/eventos/${event.id}`)}`} target="_blank">
